...
<sec:authorize access="isAuthenticated()">
	...
	<c:choose>
		<c:when test="${ses_mno eq s_list[0].sendNo }">
<script>
var abc;
		...
		<div class="row">
			<div class="col-lg-12">
					...
					<table>
						...
						<c:choose>
							...
							<tbody>
								...
								<tr>
								<td><a href="/review/myList?memberID=${mvo.receiveId}">${mvo.receiveId }</a></td>
										<c:choose>
							...
							<td>${mvo.receiveNickname }</td>
							<td>${mvo.receiveFollowingNum }</td>
							<td id="${mvo.receiveNo }" class="fn">${mvo.receiveFollowerNum }</td>
				
				<td><button type="button" id="${mvo.receiveId }" data-receiveno="${mvo.receiveNo }" data-mid=${mvo.receiveId } class="subBtn" style="visibility: hidden;font-size: 36px;color:#7fad39;" ></button></td>
			
				<td><a href="/wish/wishList?mno=${mvo.receiveNo }" class="fas fa-gift" style="font-size: 36px;color:#7fad39;"></a></td>
				<script>
				...
				function print_btn(){
					...
					let rmID_val='';
					rmID_val='<c:out value="${mvo.receiveId}"/>';
				...
				<div class="shoping__cart__table">
					<table>
						...
						<c:choose>
							...
							<td>${mvo.receiveNickname }</td>
							<td>${mvo.receiveFollowingNum }</td>
							<td id=followerNum>${mvo.receiveFollowerNum }</td>
